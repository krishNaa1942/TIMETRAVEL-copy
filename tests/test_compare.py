...
class TestCompareValidation:
    ...
    def test_missing_destinations(self, client):
        resp = client.get("/api/compare")
        assert resp.status_code == 400
        assert "required" in resp.get_json()["error"].lower()

    def test_missing_dest2(self, client):
        resp = client.get("/api/compare?dest1=Goa")
        assert resp.status_code == 400

    def test_invalid_destination(self, client):
        resp = client.get("/api/compare?dest1=Goa&dest2=Mars")
        assert resp.status_code == 400
        assert "Invalid" in resp.get_json()["error"]

    def test_same_destination(self, client):
        resp = client.get("/api/compare?dest1=Goa&dest2=Goa")
        assert resp.status_code == 400
...
class TestCompareSuccess:
    ...
    def test_compare_returns_both_profiles(self, mock_weather, client):
        mock_weather.return_value = None  # No weather key in test
        resp = client.get("/api/compare?dest1=Goa&dest2=Jaipur")
    ...
    @patch("app.services.weather_service.fetch_weather")
    def test_compare_has_budget(self, mock_weather, client):
        mock_weather.return_value = None
        resp = client.get("/api/compare?dest1=Goa&dest2=Manali")
        data = resp.get_json()
    ...
    @patch("app.services.weather_service.fetch_weather")
    def test_compare_has_safety(self, mock_weather, client):
        mock_weather.return_value = None
        resp = client.get("/api/compare?dest1=Munnar&dest2=Delhi")
        data = resp.get_json()
    ...
    @patch("app.services.weather_service.fetch_weather")
    def test_compare_includes_params(self, mock_weather, client):
        mock_weather.return_value = None
        resp = client.get(
    ...
    @patch("app.services.weather_service.fetch_weather")
    def test_compare_default_params(self, mock_weather, client):
        mock_weather.return_value = None
        resp = client.get("/api/compare?dest1=Goa&dest2=Jaipur")
        data = resp.get_json()
    ...
    @patch("app.services.weather_service.fetch_weather")
    def test_compare_all_15_destinations(self, mock_weather, client):
