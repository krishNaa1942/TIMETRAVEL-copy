...
class WebSocketService:
    ...
    async def connect(
        self, user_id: str, connection: Any, metadata: Dict = None
    ) -> str:
        """
    ...
    async def handle_message(self, client_id: str, data: str):
        ...
        try:
            ...
            await self._send_to_client(
                client_id,
                WebSocketMessage(
                    type=MessageType.ACK, payload={"message_id": message.message_id}
                ),
            )
            ...
            await self._send_to_client(
                client_id,
                WebSocketMessage(type=MessageType.ERROR, payload={"error": str(e)}),
            )
    ...
    async def send_trip_update(
        ...
        message = WebSocketMessage(
            type=update_type, payload={"trip_id": trip_id, **data}
        )
    ...
    async def send_notification(
        self, user_id: str, title: str, body: str, data: Dict[str, Any] = None
    ):
        """
    ...
    async def send_insight(
        self, user_id: str, insight_type: str, title: str, content: str
    ):
        """
        ...
        message = WebSocketMessage(
            ...
            payload={"insight_type": insight_type, "title": title, "content": content},
        )
