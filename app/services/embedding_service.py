...
class EmbeddingService:
    ...
    def __init__(self, db_service=None, cache_service=None):
        ...
        try:
            ...
            logger.warning("OpenAI package not installed - embeddings will use fallback")
    ...
    def generate_batch_embeddings(
        ...
        if uncached_texts:
            ...
            for idx, (text, embedding) in enumerate(zip(uncached_texts, batch_embeddings)):
    ...
    def _fallback_embedding(self, text: str) -> List[float]:
        ...
        styles = ["adventure", "relaxation", "cultural", "business", "nature", "beach", "mountain", "city"]
        ...
        # Activity features
        activities = ["hiking", "swimming", "sightseeing", "shopping", "dining", "museums", "nightlife", "spa"]
    ...
    def _searches_to_text(self, searches: List[Dict[str, Any]], decay_factor: float = 0.95) -> str:
