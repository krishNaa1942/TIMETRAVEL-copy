    ...
    def to_fcm_payload(self, token: str) -> Dict[str, Any]:
        ...
        payload = {
            ...
            "android": {
                ...
                "ttl": f"{self.ttl}s",
                "notification": {"sound": self.sound, "channel_id": "default"},
            },
            "apns": {
                "headers": {
                    "apns-priority": (
                        "10" if self.priority == NotificationPriority.HIGH else "5"
                    ),
...
class PushNotificationService:
    ...
    async def send_notification(
        self, user_id: str, notification: PushNotification
    ) -> Dict[str, Any]:
        """
        ...
        if not devices:
            ...
            return {"success": False, "message": "No active devices", "sent_count": 0}
    ...
    async def send_batch_notifications(
        self, user_ids: List[str], notification: PushNotification
    ) -> Dict[str, Any]:
        """
    ...
    async def send_trip_reminder(
        self, user_id: str, trip_id: str, destination: str, days_until: int
    ) -> Dict[str, Any]:
    ...
    async def send_trip_invitation(
        self, user_id: str, trip_id: str, trip_name: str, inviter_name: str
    ) -> Dict[str, Any]:
    ...
    async def send_chat_message(
        self, user_id: str, trip_id: str, sender_name: str, message_preview: str
    ) -> Dict[str, Any]:
        ...
        notification = PushNotification(
            ...
            data={"trip_id": trip_id, "sender_name": sender_name},
        )
    ...
    async def _send_to_device(
        self, device: DeviceToken, notification: PushNotification
    ) -> bool:
        ...
        try:
            ...
            message = messaging.Message(
                ...
                android=messaging.AndroidConfig(
                    ...
                    notification=messaging.AndroidNotification(
                        sound=notification.sound, channel_id="travel_updates"
                    ),
                ),
            ...
            if (
                "invalid-registration-token" in str(e).lower()
                or "not-registered" in str(e).lower()
            ):
                device.is_active = False
                logger.warning(
                    f"Token for device {device.device_id} is invalid, deactivated"
                )
