...
_FALLBACK_WEATHER = {
    # Hill stations
    "manali": {"temp": 15, "feels_like": 12, "humidity": 65, "desc": "Pleasant mountain weather"},
    "shimla": {"temp": 18, "feels_like": 15, "humidity": 60, "desc": "Cool and clear"},
    "darjeeling": {"temp": 16, "feels_like": 14, "humidity": 75, "desc": "Misty mountains"},
    "ooty": {"temp": 15, "feels_like": 13, "humidity": 70, "desc": "Pleasant hill station"},
    "munnar": {"temp": 20, "feels_like": 18, "humidity": 80, "desc": "Cool tea gardens"},
    "kodaikanal": {"temp": 17, "feels_like": 15, "humidity": 72, "desc": "Pleasant and misty"},
    "coorg": {"temp": 22, "feels_like": 21, "humidity": 75, "desc": "Pleasant coffee lands"},
    "kasol": {"temp": 14, "feels_like": 11, "humidity": 55, "desc": "Cool mountain air"},
    "gulmarg": {"temp": 10, "feels_like": 6, "humidity": 60, "desc": "Cold and scenic"},
    "srinagar": {"temp": 18, "feels_like": 16, "humidity": 62, "desc": "Pleasant valley"},
    "leh": {"temp": 12, "feels_like": 8, "humidity": 35, "desc": "Cold desert"},
    "nainital": {"temp": 18, "feels_like": 16, "humidity": 68, "desc": "Cool lake breeze"},
    "mussoorie": {"temp": 20, "feels_like": 18, "humidity": 65, "desc": "Queen of hills"},
    "dharamshala": {"temp": 18, "feels_like": 16, "humidity": 60, "desc": "Cool mountain town"},
    
    # Beaches
    "goa": {"temp": 30, "feels_like": 34, "humidity": 80, "desc": "Tropical beach paradise"},
    "kerala": {"temp": 29, "feels_like": 33, "humidity": 85, "desc": "Tropical backwaters"},
    "andaman": {"temp": 28, "feels_like": 32, "humidity": 82, "desc": "Tropical island bliss"},
    "lakshadweep": {"temp": 28, "feels_like": 32, "humidity": 80, "desc": "Tropical island paradise"},
    "kovalam": {"temp": 29, "feels_like": 33, "humidity": 82, "desc": "Sunny beach weather"},
    "varkala": {"temp": 29, "feels_like": 33, "humidity": 80, "desc": "Coastal paradise"},
    "pondicherry": {"temp": 30, "feels_like": 34, "humidity": 78, "desc": "Coastal charm"},
    ...
    "bangalore": {"temp": 26, "feels_like": 26, "humidity": 65, "desc": "Pleasant garden city"},
    ...
    "jaipur": {"temp": 34, "feels_like": 38, "humidity": 35, "desc": "Hot desert climate"},
    "udaipur": {"temp": 32, "feels_like": 35, "humidity": 40, "desc": "Warm city of lakes"},
    "jaisalmer": {"temp": 36, "feels_like": 40, "humidity": 25, "desc": "Hot desert"},
    
    # Heritage sites
    "agra": {"temp": 34, "feels_like": 38, "humidity": 40, "desc": "Warm and sunny"},
    "varanasi": {"temp": 33, "feels_like": 37, "humidity": 50, "desc": "Warm spiritual city"},
    "khajuraho": {"temp": 32, "feels_like": 36, "humidity": 45, "desc": "Warm and clear"},
    "hampi": {"temp": 32, "feels_like": 35, "humidity": 55, "desc": "Warm ruins"},
    
    # Wildlife
    "ranthambore": {"temp": 32, "feels_like": 36, "humidity": 40, "desc": "Warm safari weather"},
    "jim corbett": {"temp": 28, "feels_like": 30, "humidity": 65, "desc": "Jungle climate"},
    "kaziranga": {"temp": 28, "feels_like": 32, "humidity": 85, "desc": "Humid grasslands"},
    "bandhavgarh": {"temp": 30, "feels_like": 34, "humidity": 55, "desc": "Warm jungle"},
    "kanha": {"temp": 29, "feels_like": 32, "humidity": 60, "desc": "Pleasant jungle"},
    
    # Northeast
    "gangtok": {"temp": 18, "feels_like": 15, "humidity": 70, "desc": "Cool mountain capital"},
    "shillong": {"temp": 20, "feels_like": 18, "humidity": 75, "desc": "Scotland of the East"},
    "tawang": {"temp": 12, "feels_like": 8, "humidity": 60, "desc": "Cold mountain air"},
    "meghalaya": {"temp": 18, "feels_like": 16, "humidity": 85, "desc": "Abode of clouds"},
}
