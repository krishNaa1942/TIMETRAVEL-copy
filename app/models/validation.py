...
class TripQuery(BaseModel):
    ...
    sort_by: Optional[str] = Field("created_at", regex="^(created_at|start_date|name|budget)$")
...
__all__ = [
    # Enums
    'TripStatus', 'DestinationType', 'AccommodationType', 'Currency',
    # Auth
    'LoginRequest', 'RegisterRequest', 'PasswordResetRequest', 'UpdatePasswordRequest',
    # Trip
    'DestinationInput', 'TripCreate', 'TripUpdate', 'TripQuery',
    # Itinerary
    'ItineraryActivity', 'ItineraryDay', 'ItineraryCreate',
    # Budget
    'BudgetItem', 'BudgetCreate',
    # Recommendation
